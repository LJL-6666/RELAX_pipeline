...
%% HORIZONTAL EYE MOVEMENT MARKING BY LATERAL ELECTRODES ON OPPOSITE SIDES OF THE HEAD SHOWING VALUES OF THE OPPOSITE POLARITY, BOTH LARGER THAN MEDIAN +/- X MAD:
        ...
        max_left_idx = size(Leftpattern, 2);  % 获取Leftpattern的最大列数
        for x = 1:size(continuousEEG.chanlocs,2)
            if max_left_idx >= 1 && strcmpi(continuousEEG.chanlocs(x).labels, Leftpattern(1,1))==1
                LeftHEyeChannelLocationList(1,x) = strcmpi(continuousEEG.chanlocs(x).labels, Leftpattern(1,1));  
            end
        end
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 2
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 3
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 4
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 5
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 6
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 7
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 8
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('LeftHEyeChannelLocationList','var') ~= 1 && max_left_idx >= 9
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        max_right_idx = size(Rightpattern, 2);  % 获取Rightpattern的最大列数
        for x = 1:size(continuousEEG.chanlocs,2)
            if max_right_idx >= 1 && strcmpi(continuousEEG.chanlocs(x).labels, Rightpattern(1,1))==1
                RightHEyeChannelLocationList(1,x) = strcmpi(continuousEEG.chanlocs(x).labels, Rightpattern(1,1));  
            end
        end
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 2
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 3
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 4
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 5
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 6
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 7
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 8
            for x = 1:size(continuousEEG.chanlocs,2)
        ...
        if exist('RightHEyeChannelLocationList','var') ~= 1 && max_right_idx >= 9
            for x = 1:size(continuousEEG.chanlocs,2)
