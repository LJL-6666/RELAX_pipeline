...
RELAX_epoching_cfg.TriggersToEpoch={'61' '62' '63' '64' '65' '66' '67' }; % triggers to use for epoching
RELAX_epoching_cfg.PeriodToEpoch=[-0.2 1]; % [start end] surrounding trigger
...
RELAX_epoching_cfg.NumberOfFactors=1;
RELAX_epoching_cfg.NumberOfConditions=6;
RELAX_epoching_cfg.BL_correction_Factor_1_Level_1={'61'}; % triggers to include in factor 1's level 1 for regression BL correction (all other triggers are included in factor 1's level 2)
RELAX_epoching_cfg.BL_correction_Factor_1_Levels={'62','63','64','65','66','67'}; % triggers to include in factor 1's level 1 for regression BL correction (all other triggers are included in factor 1's level 2)

RELAX_epoching_cfg.BL_correction_Factor_2_Level_1={}; % triggers to include in factor 2's level 1 for regression BL correction (all other triggers are included in factor 2's level 2)
...
% Whether to plot rejected epochs after
RELAX_epoching_cfg.PlotEpochRejection = false;
